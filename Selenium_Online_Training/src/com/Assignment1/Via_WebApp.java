...
//		driver.findElement(By.partialLinkText("Support")).click();
		...
		WebElement date = driver.findElement(By.xpath("//div[@id='depart-cal']//span[contains(text(),"+year+")]//span[text()='Apr']/../../..//div[text()='25' and not (contains(@class,'vc-disabled-cell'))]"));
		date.click();
		Thread.sleep(3000);
		driver.quit();
	}
